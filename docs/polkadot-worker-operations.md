...
ECR scanning of worker image tag `mainnet-20260913-2` reported **0 critical and 1 high finding**: `CVE-2026-85091` in Debian zlib `1:1.3.dfsg+really1.3.1-1`. The image does not have a clean scan. At review, Debian listed no fixed package, upstream's latest release was 1.3.2, and its issue remained open without a released fix. [Debian CVE status](https://security-tracker.debian.org/tracker/CVE-2026-85091), [upstream releases](https://zlib.net/), [upstream issue](https://github.com/madler/zlib/issues/1310).
