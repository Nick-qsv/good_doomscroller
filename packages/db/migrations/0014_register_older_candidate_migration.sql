...
-- Migration0013 inserted its approvals but omitted its completion record.
-- Preserve the applied file. Register it only after all exact rows are present.
DO $$
BEGIN
    IF EXISTS (
    ...
    ('f153534c-5cc9-56d0-a10b-59a9cd03ce4f', '2c4b79aa-ee6c-5652-b647-d1335cd3f8aa', '1b1ea052d47e5177c5b8a75b06cea7d2ef4295e6856d695293dddc9a9ce60e05', 'd43472c4b18c0b5bb661c15f97003f0f32f469f7aa7494b6f78886ff51bdc2c7', 'https://www.gutenberg.org/ebooks/15399')
        ) AS expected(edition_id, book_id, source_sha256, normalized_sha256, source_url)
        LEFT JOIN corpus_publication_approvals actual
          ON actual.edition_id = expected.edition_id::uuid
          AND actual.book_id = expected.book_id::uuid
        ...
        RAISE EXCEPTION 'Cannot register candidate approvals: exact rows are missing';
    END IF;
END;
$$;
INSERT INTO schema_migrations(version)
VALUES ('0013_older_candidate_approvals'), ('0014_register_older_candidate_migration')
